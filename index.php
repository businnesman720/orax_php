                    ...
                    <a href="video.php?id=<?php echo $vid['id']; ?>" class="video-card-link" style="text-decoration: none; color: inherit;">
                        <div class="video-card animate-fade">
                            <div class="thumbnail-container" data-video-url="<?php echo $vid['video_url']; ?>" data-video-type="<?php echo $vid['video_type']; ?>">
                                ...
                                <?php if(!empty($vid['quality']) && $vid['quality'] !== 'HD'): ?>
                                    <div class="quality-badge" style="position: absolute; top: 10px; left: 10px; background: var(--primary-red); color: #fff; padding: 2px 8px; border-radius: 5px; font-size: 0.7rem; font-weight: 800; z-index: 10;"><?php echo $vid['quality']; ?></div>
                                <?php endif; ?>
